 ...
 * @author tur
 * @version 1.0
 * @date 2023/3/26 18:27
 * @description 响应码枚举
 */
public enum ResponseCodeEnum {

    SUCCESS(200, "SUCCESS"), // 操作成功
    FAILURE(400, "FAILURE"), // 操作失败
    QQ_LOGIN_ERROR(5301, "QQ登录错误"),
    WEIBO_LOGIN_ERROR(53002, "微博登录错误"),
    GITEE_LOGIN_ERROR(53003, "gitee登录错误"),
    ...
    NOT_LOGIN(401, "请先登录"),
    NO_PERMISSION(-7, "无权限操作"),
    ERROR_PASSWORD(-8, "用户账号或密码错误"),
    DISABLE_ACCOUNT(-9, "账号已被禁用"),
    EMAIL_DISABLE_LOGIN(-12, "该邮箱已被管理员禁止登录"),

    // 服务层面
    EMAIL_ERROR(-10, "邮箱格式不对，请稍后重试"),
    ...
    ERROR_MUST_REGISTER(10017, "请先注册账号"),
    PARAMS_ILLEGAL(10018, "参数不合法"),
    CATEGORY_IS_EXIST(10019, "该分类名称已存在"),
    CATEGORY_IS_TOP(10020, "该分类已在顶端"),
