...
public class ArticleController {
    ...
    @GetMapping("web/article/condition")
    ...
    @GetMapping("/web/article/archive")
    ...
    @GetMapping("/web/article/checkSecret")
